...
# Load the shared library from the package lib dir, under the overall package directory
lib_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "..", "..", "lib", "libembeddings.dylib"
)
embeddings_lib = ctypes.CDLL(lib_path)
